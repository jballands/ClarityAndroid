 ...
 * @version 1.0
 */
public class Clarity_PatientModel implements Parcelable {
	 ...
	 */
	public Clarity_PatientModel(Parcel in) {
	...
	public static final Parcelable.Creator<Clarity_PatientModel> CREATOR = new Parcelable.Creator<Clarity_PatientModel>() {
        public Clarity_PatientModel createFromParcel(Parcel in) {
            return new Clarity_PatientModel(in);
        }

        public Clarity_PatientModel[] newArray(int size) {
            return new Clarity_PatientModel[size];
        }
    };
