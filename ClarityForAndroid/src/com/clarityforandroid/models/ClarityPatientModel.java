 ...
 * @version 1.0
 */
public class ClarityPatientModel implements Parcelable {
	 ...
	 */
	public ClarityPatientModel(Parcel in) {
	 ...
	 */
	public ClarityPatientModel(String pre, String first, String middle, String last, String suf, String sx, String dob, 
	...
	public static final Parcelable.Creator<ClarityPatientModel> CREATOR = new Parcelable.Creator<ClarityPatientModel>() {
        public ClarityPatientModel createFromParcel(Parcel in) {
            return new ClarityPatientModel(in);
        }

        public ClarityPatientModel[] newArray(int size) {
            return new ClarityPatientModel[size];
        }
    };
