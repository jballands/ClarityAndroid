 ...
 * @version 1.0
 */
public class Clarity_ProviderModel implements Parcelable {
	 ...
	 */
	public Clarity_ProviderModel(Parcel in) {
	 ...
	 */
	public Clarity_ProviderModel(String first, String last, String user, String loc, String tok, Bitmap pho) {
		firstName = first;
		lastName = last;
		username = user;
		location = loc;
	...
	public static final Parcelable.Creator<Clarity_ProviderModel> CREATOR = new Parcelable.Creator<Clarity_ProviderModel>() {
